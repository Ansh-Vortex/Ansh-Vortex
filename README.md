...
![NGINX](https://img.shields.io/badge/nginx-009639?style=for-the-badge&logo=nginx&logoColor=black)
...
- 🤖 **Telegram Bots**
  ...
  - Inline WebApps & admin panels
  - High-scale user & credit systems

- 🌐 **Web Applications**
  - Full-stack dashboards & SaaS apps
  - REST APIs & backend systems
  - Auth, payments & real-time features

- ⚙️ **APIs & Automation**
  - OSINT & data aggregation APIs
  - Telegram, social & utility APIs
  - Workflow automation & integrations

- 🔍 **OSINT Tools**
  - Phone, email & social intelligence
  - Database-driven lookup systems
